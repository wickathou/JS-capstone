import getSource from './showClass.js';
...
const loadData = async (id) => {
  const fetcs = await fetch(
    `https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/BDiHo1eWo7TvFu0NP10u/comments?item_id=${id}`,
  );
